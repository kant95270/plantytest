		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('27 November 2023','tpgb').' <span class="changelog-version">'.esc_html__('3.2.1','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Added : Heading Block','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Button Block','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Icon Box Block','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Image Block','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Interactive Circle Info : Button option','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Pro Paragraph : New Column Option & Drop Cap Option added in Pro Paragraph.','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Component : Typography Font Family add Font : "Plus Jakarta Sans"','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Need Help : All Blocks add Demo Page URL and Documentation URL easy to find','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : Component : Typography Font Size add Unit "REM"','tpgb').'</li>';
						echo '<li>'.esc_html__('Improved : Attributes Block Unique Id','tpgb').'</li>';
						echo '<li>'.esc_html__('Updated : Progress Bar : Progress Value Dynamic Field Compatibility','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : Content Views Plugin Compatibility','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : MailPoet Plugin Compatibility','tpgb').'</li>';
						echo '<li>'.esc_html__('Changed : Block Name : Heading Title to Advance Heading','tpgb').'</li>';
						echo '<li>'.esc_html__('Changed : Block Name : Button to Advance Button','tpgb').'</li>';
						echo '<li>'.esc_html__('Changed : Block Name : Image to Advanced Image','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Carousel Anything : Hide Carousel Height Bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Container : WP Core Blocks Conflict Editor CSS Bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Search Bar : Include Exclude query bug fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Style Book Bug Fix in FSE Theme','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Gutenberg Core Image Block Bug Fix inside Container Inner','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Patterns : Preview TP Blocks CSS Bug Fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
