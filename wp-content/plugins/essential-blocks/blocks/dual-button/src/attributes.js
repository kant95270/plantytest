...
const attributes = {
    ...
    ...generateBackgroundAttributes(BUTTON_ONE_BACKGROUND, {
        ...
        noMainBgi: true,
        defaultBgGradient: "linear-gradient(45deg, rgba(120,102,255,0.8) 0% , rgba(195,120,242,0.4) 100%)",
        defaultHovBgGradient: "linear-gradient(45deg, rgba(48,155,255,1) 0% , rgba(33,135,255,1) 100%)",
    }),
    ...generateBackgroundAttributes(BUTTON_TWO_BACKGROUND, {
        noOverlay: true,
        noMainBgi: true,
        defaultBgGradient: "linear-gradient(45deg, rgba(48,155,255,1) 0% , rgba(33,135,255,1) 100%)",
        defaultHovBgGradient: "linear-gradient(45deg, rgba(120,102,255,0.8) 0% , rgba(195,120,242,0.4) 100%)",
    }),
};
